...
class Particle {
  ...
  _setMesh() {
    ...
    async function init() {
      // （1）loadGLTF
      await Utils.loadGLTF(particle, '/pages/fragments/model/24-12-16_fragments.glb');
      ...
      const wire_01 = await Utils.loadGLTF(new Object(), '/pages/fragments/model/25-01-13_wire_01.glb');
      Utils.wireTypes.push(wire_01[0].geometry);

      const wire_02 = await Utils.loadGLTF(new Object(), '/pages/fragments/model/25-01-13_parallelepiped2.glb');
      Utils.wireTypes.push(wire_02[0].geometry);

      const wire_03 = await Utils.loadGLTF(new Object(), '/pages/fragments/model/25-01-13_moon.glb');
